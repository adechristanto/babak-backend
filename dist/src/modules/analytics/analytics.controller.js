...
let AnalyticsController = class AnalyticsController {
    ...
    async getTopListings(req, limit = 5) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: dashboard_stats_dto_1.DashboardOverviewDto
    }),
...
__decorate([
    (0, common_1.Get)('top-listings'),
    (0, swagger_1.ApiOperation)({ summary: 'Get top performing listings' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Top listings retrieved successfully',
        type: [dashboard_stats_dto_1.TopListingDto]
    }),
    (0, swagger_1.ApiQuery)({ name: 'limit', description: 'Number of listings to return', required: false, example: 5 }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Query)('limit', new common_1.ParseIntPipe({ optional: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number]),
    __metadata("design:returntype", Promise)
], AnalyticsController.prototype, "getTopListings", null);
