...
const allow_unverified_decorator_1 = require("../auth/decorators/allow-unverified.decorator");
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Profile retrieved successfully', type: user_response_dto_1.UserResponseDto }),
    (0, swagger_1.ApiBearerAuth)(),
