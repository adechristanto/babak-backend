...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'iPhone', required: false, description: 'Search query for title and description' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SearchListingsDto.prototype, "q", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, required: false, description: 'Category ID to filter by' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'New York', required: false, description: 'City to filter by' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SearchListingsDto.prototype, "city", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.ListingStatus, required: false, default: client_1.ListingStatus.ACTIVE }),
    (0, class_validator_1.IsEnum)(client_1.ListingStatus),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], SearchListingsDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: true, required: false, description: 'Filter VIP listings only' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: true, required: false, description: 'Filter featured listings only' }),
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => value === 'true'),
    __metadata("design:type", Boolean)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, required: false, description: 'Seller ID to filter by' }),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
