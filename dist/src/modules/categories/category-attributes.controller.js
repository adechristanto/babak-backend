...
__decorate([
    (0, common_1.Post)(':categoryId/attributes'),
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Category attribute created successfully', type: category_attribute_dto_1.CategoryAttributeResponseDto }),
...
__decorate([
    (0, common_1.Post)(':categoryId/attributes/bulk'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN, client_1.UserRole.SUPERUSER),
    (0, swagger_1.ApiOperation)({ summary: 'Create multiple category attributes' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Category attributes created successfully', type: [category_attribute_dto_1.CategoryAttributeResponseDto] }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Category not found' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Some attribute keys already exist' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('categoryId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category attributes retrieved successfully', type: [category_attribute_dto_1.CategoryAttributeResponseDto] }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':categoryId/attributes/inherited'),
    (0, swagger_1.ApiOperation)({ summary: 'Get attributes for a category including inherited from parents' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category attributes retrieved successfully', type: [category_attribute_dto_1.CategoryAttributeResponseDto] }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Category not found' }),
    __param(0, (0, common_1.Param)('categoryId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category attribute retrieved successfully', type: category_attribute_dto_1.CategoryAttributeResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category attribute updated successfully', type: category_attribute_dto_1.CategoryAttributeResponseDto }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Category attribute not found' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Attribute key already exists' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 204, description: 'Category attribute deleted successfully' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Category attribute not found' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Cannot delete attribute in use' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
...
__decorate([
    (0, common_1.Post)(':categoryId/attributes/reorder'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN, client_1.UserRole.SUPERUSER),
    (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT),
    (0, swagger_1.ApiOperation)({ summary: 'Reorder category attributes' }),
    (0, swagger_1.ApiResponse)({ status: 204, description: 'Attributes reordered successfully' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Category not found' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid attribute IDs' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('categoryId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
