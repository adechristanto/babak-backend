...
__decorate(
  [
    ...
    (0, swagger_1.ApiResponse)({
      status: 409,
      description: 'Attribute key already exists',
    }),
    ...
    __metadata('design:paramtypes', [
      Number,
      category_attribute_dto_1.CreateCategoryAttributeDto,
    ]),
    __metadata('design:returntype', Promise),
  ],
  CategoryAttributesController.prototype,
  'create',
  null,
);
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'Create multiple category attributes',
    }),
    (0, swagger_1.ApiResponse)({
      status: 201,
...
__decorate(
  [
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({
      summary: 'Get a specific category attribute',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      Number,
      category_attribute_dto_1.UpdateCategoryAttributeDto,
    ]),
    __metadata('design:returntype', Promise),
  ],
  CategoryAttributesController.prototype,
...
exports.CategoryAttributesController = CategoryAttributesController =
  __decorate(
    [
      ...
      __metadata('design:paramtypes', [
        category_attributes_service_1.CategoryAttributesService,
      ]),
    ],
