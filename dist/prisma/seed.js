...
async function createCategoryAttributes(createdCategories, createdSubcategories) {
    ...
    if (phonesCategory) {
        const phoneGeneralAttrs = [
            { name: 'Brand', key: 'brand', type: client_1.AttributeType.TEXT, dataType: client_1.AttributeDataType.STRING, required: true, searchable: true, displayOrder: 1 },
            { name: 'Model', key: 'model', type: client_1.AttributeType.TEXT, dataType: client_1.AttributeDataType.STRING, required: true, searchable: true, displayOrder: 2 },
            { name: 'Storage Capacity', key: 'storage', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['32GB', '64GB', '128GB', '256GB', '512GB', '1TB'], displayOrder: 3 },
            ...
            { name: 'Warranty', key: 'warranty', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['no_warranty', '3_months', '6_months', '12_months'], displayOrder: 5 },
            { name: 'Accessories Included', key: 'accessories_included', type: client_1.AttributeType.MULTISELECT, dataType: client_1.AttributeDataType.JSON, required: false, searchable: true, options: ['box', 'charger', 'cable', 'earbuds', 'case', 'screen_protector'], displayOrder: 6 },
        ];
        ...
        if (mobilePhones) {
            const mobileAttrs = [
                { name: 'Operating System', key: 'os', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['ios', 'android', 'other'], displayOrder: 1 },
                { name: 'Screen Size', key: 'screen_size', type: client_1.AttributeType.NUMBER, dataType: client_1.AttributeDataType.DECIMAL, required: false, searchable: true, unit: 'in', validation: { min: 4.7, max: 7.6, decimalPlaces: 1 }, displayOrder: 2 },
                { name: 'RAM', key: 'ram', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['2GB', '3GB', '4GB', '6GB', '8GB', '12GB', '16GB'], displayOrder: 3 },
                { name: 'Battery Health', key: 'battery_health', type: client_1.AttributeType.NUMBER, dataType: client_1.AttributeDataType.INTEGER, required: false, searchable: true, unit: '%', validation: { min: 50, max: 100 }, displayOrder: 4 },
                { name: 'Dual SIM', key: 'dual_sim', type: client_1.AttributeType.BOOLEAN, dataType: client_1.AttributeDataType.BOOLEAN, required: false, searchable: true, displayOrder: 5 },
            ];
    ...
    if (computersCategory) {
        const computerGeneralAttrs = [
            { name: 'Device Type', key: 'device_type', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['laptop', 'desktop', 'monitor', 'accessory'], displayOrder: 1 },
            { name: 'Brand', key: 'brand', type: client_1.AttributeType.TEXT, dataType: client_1.AttributeDataType.STRING, required: true, searchable: true, displayOrder: 2 },
            { name: 'Model', key: 'model', type: client_1.AttributeType.TEXT, dataType: client_1.AttributeDataType.STRING, required: true, searchable: true, displayOrder: 3 },
        ];
        ...
        if (laptops) {
            const laptopAttrs = [
                { name: 'CPU', key: 'cpu', type: client_1.AttributeType.TEXT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, displayOrder: 1 },
                { name: 'RAM', key: 'ram', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['4GB', '8GB', '16GB', '32GB', '64GB'], displayOrder: 2 },
                { name: 'Storage', key: 'storage', type: client_1.AttributeType.SELECT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, options: ['128GB SSD', '256GB SSD', '512GB SSD', '1TB SSD', '2TB SSD', 'HDD'], displayOrder: 3 },
                { name: 'GPU', key: 'gpu', type: client_1.AttributeType.TEXT, dataType: client_1.AttributeDataType.STRING, required: false, searchable: true, displayOrder: 4 },
            ];
