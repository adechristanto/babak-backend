...
async function createCategoryAttributes(
  createdCategories,
  ...
  if (electronicsCategory) {
    ...
    const refrigerators = createdSubcategories.get(
  ...
  if (furnitureCategory) {
    ...
    for (const attr of furnitureAttributes) {
      await prisma.categoryAttribute.upsert({
        where: {
          categoryId_key: { categoryId: furnitureCategory.id, key: attr.key },
        },
        update: {},
  ...
  if (clothingCategory) {
    ...
    for (const attr of clothingAttributes) {
      await prisma.categoryAttribute.upsert({
        where: {
          categoryId_key: { categoryId: clothingCategory.id, key: attr.key },
        },
        update: {},
  ...
  if (phonesCategory) {
    const phoneGeneralAttrs = [
      ...
      },
      {
        ...
        required: false,
        searchable: true,
        options: ['no_warranty', '3_months', '6_months', '12_months'],
        displayOrder: 5,
      },
      {
        name: 'Accessories Included',
        key: 'accessories_included',
        type: client_1.AttributeType.MULTISELECT,
        dataType: client_1.AttributeDataType.JSON,
        required: false,
        searchable: true,
        options: [
          'box',
    ...
    for (const attr of phoneGeneralAttrs) {
      await prisma.categoryAttribute.upsert({
        where: {
          categoryId_key: { categoryId: phonesCategory.id, key: attr.key },
        },
        update: {},
    ...
    if (mobilePhones) {
      const mobileAttrs = [
        ...
        },
        {
          ...
          searchable: true,
          unit: 'in',
          validation: { min: 4.7, max: 7.6, decimalPlaces: 1 },
          displayOrder: 2,
        },
        {
          name: 'RAM',
      ...
      for (const attr of mobileAttrs) {
        await prisma.categoryAttribute.upsert({
          where: {
            categoryId_key: { categoryId: mobilePhones.id, key: attr.key },
          },
          update: {},
  ...
  if (computersCategory) {
    const computerGeneralAttrs = [
      {
        ...
        required: false,
        searchable: true,
        options: ['laptop', 'desktop', 'monitor', 'accessory'],
        displayOrder: 1,
      },
      {
        name: 'Brand',
    ...
    for (const attr of computerGeneralAttrs) {
      await prisma.categoryAttribute.upsert({
        where: {
          categoryId_key: { categoryId: computersCategory.id, key: attr.key },
        },
        update: {},
      ...
      const truckAttrs = [
        {
          ...
          searchable: true,
          unit: 'kg',
          validation: { min: 1000, max: 40000, decimalPlaces: 0 },
          displayOrder: 1,
        },
        {
          name: 'Payload',
      ...
      const marineAttrs = [
        {
          ...
          required: false,
          searchable: true,
          options: ['sailboat', 'motorboat', 'yacht', 'inflatable', 'other'],
          displayOrder: 1,
        },
        {
          name: 'Length',
          ...
          searchable: true,
          unit: 'ft',
          validation: { min: 6, max: 200, decimalPlaces: 1 },
          displayOrder: 2,
        },
        {
          name: 'Engine Type',
  ...
  if (realEstateCategory) {
    ...
    if (apartments) {
      const aptAttrs = [
        {
          ...
          required: false,
          searchable: true,
          options: ['studio', '1br', '2br', '3br', '4br_plus'],
          displayOrder: 1,
        },
        {
          name: 'HOA/Maintenance Fee',
          key: 'maintenance_fee',
          type: client_1.AttributeType.NUMBER,
          dataType: client_1.AttributeDataType.DECIMAL,
          required: false,
          searchable: false,
          unit: 'USD/mo',
          validation: { min: 0, max: 5000, decimalPlaces: 2 },
          displayOrder: 2,
        },
        {
          name: 'Elevator',
      ...
      for (const attr of aptAttrs) {
        await prisma.categoryAttribute.upsert({
          where: {
            categoryId_key: { categoryId: apartments.id, key: attr.key },
          },
          update: {},
    ...
    if (houses) {
      const houseAttrs = [
        ...
        },
        {
          ...
          required: false,
          searchable: true,
          options: ['none', 'unfinished', 'finished'],
          displayOrder: 4,
        },
      ];
    ...
    if (land) {
      const landAttrs = [
        ...
        },
        {
          ...
          required: false,
          searchable: true,
          options: ['water', 'electricity', 'gas', 'sewer', 'internet'],
          displayOrder: 5,
        },
      ];
...
const productData = {
  'real-estate': [
    ...
    },
    {
      ...
      price: 180000,
      description: 'Ready to build residential land',
    },
    {
    ...
    },
    {
      ...
      price: 420000,
      description: 'Tourist property with ocean views',
    },
    {
    ...
    },
    {
      ...
      price: 380000,
      description: '3BR house with large backyard',
    },
    {
  ...
  vehicles: [
    ...
    },
    {
      ...
      price: 35000,
      description: 'Reliable work truck with towing capacity',
    },
    {
      title: 'John Deere Tractor',
      price: 45000,
      description: 'Agricultural tractor for farming',
    },
    {
      title: 'Luxury Yacht 40ft',
      price: 250000,
      description: 'Beautiful yacht for marine adventures',
    },
    {
      title: 'BMW X5 SUV',
      price: 42000,
    ...
    },
    {
      ...
      price: 18000,
      description: 'Classic Harley in mint condition',
    },
    {
      title: 'Commercial Delivery Van',
      price: 28000,
      description: 'Perfect for business delivery',
    },
    {
    ...
    },
    {
      title: 'Boat Trailer',
      price: 3500,
      description: 'Heavy-duty trailer for boats',
    },
  ],
  electronics: [
    {
    ...
    },
    {
      ...
      price: 200,
      description: 'Built-in microwave with convection',
    },
    {
    ...
    },
    {
      ...
      price: 600,
      description: 'Premium audio system with subwoofer',
    },
  ],
  furniture: [
    {
      ...
      price: 450,
      description: 'Modern wooden bed frame with headboard',
    },
    {
      title: 'Leather Living Room Set',
      price: 1200,
      description: '3-seater sofa with matching chairs',
    },
    {
    ...
    },
    {
      title: 'Kids Bunk Bed',
      price: 350,
      description: 'Twin over twin bunk bed for children',
    },
    {
    ...
    {
      title: 'Garden Patio Set',
      price: 600,
      description: 'Outdoor furniture set with umbrella',
    },
    {
      title: 'Chandelier Light Fixture',
      price: 300,
    ...
    },
    {
      ...
      price: 180,
      description: '5-shelf bookcase in dark wood',
    },
    {
      title: 'Coffee Table',
      price: 250,
  ...
  'phones-accessories': [
    ...
    {
      title: 'iPhone Case Collection',
      price: 30,
      description: 'Premium protective phone cases',
    },
    {
      title: 'AirPods Pro',
      price: 250,
    ...
    },
    {
      ...
      price: 25,
      description: 'USB-C and Lightning cables',
    },
    {
      title: 'Premium Phone Number',
      price: 500,
      description: 'Memorable phone number for business',
    },
  ],
  'computers-accessories': [
    ...
    },
    {
      ...
      price: 300,
      description: '4K monitor for professional use',
    },
    {
    ...
    },
    {
      ...
      price: 200,
      description: 'All-in-one printer with scanner',
    },
    {
    ...
    },
    {
      ...
      price: 600,
      description: 'Software license for design work',
    },
  ],
  'childrens-world': [
    {
    ...
    },
    {
      title: 'Baby Stroller',
      price: 200,
      description: 'Lightweight stroller with canopy',
    },
    {
      title: 'Car Seat for Toddler',
      price: 150,
      description: 'Safety car seat with 5-point harness',
    },
    {
      title: 'Educational Toy Set',
      price: 35,
      description: 'Learning toys for early development',
    },
    {
      title: "Children's Book Collection",
      price: 25,
      description: "Set of classic children's books",
    },
    {
      title: 'Baby Care Kit',
      price: 40,
    ...
    },
    {
      ...
      price: 30,
      description: 'Natural baby food variety pack',
    },
  ],
  clothing: [
    {
      ...
      price: 300,
      description: 'Professional business suit set',
    },
    {
    ...
    },
    {
      ...
      price: 200,
      description: 'Premium brand sunglasses',
    },
  ],
  jobs: [
    {
      ...
      price: 0,
      description: 'Full-stack developer job opportunity',
    },
    {
      title: 'Marketing Manager Role',
      price: 0,
      description: 'Senior marketing position available',
    },
    {
      title: 'Graphic Designer Portfolio',
      price: 0,
      description: 'Creative designer seeking projects',
    },
  ],
  'solar-energy': [
    {
      ...
      price: 8000,
      description: 'Complete solar panel system',
    },
    {
    ...
    },
    {
      ...
      price: 2500,
      description: 'Deep cycle solar batteries',
    },
    {
      title: 'Solar Charge Controller',
      price: 300,
      description: 'MPPT charge controller',
    },
    {
  ...
  'services-businesses': [
    ...
    },
    {
      ...
      price: 200,
      description: 'Complete automotive repair',
    },
    {
    ...
    },
    {
      ...
      price: 150,
      description: '24/7 IT technical support',
    },
    {
      title: 'Online Tutoring',
      price: 50,
      description: 'Personalized online tutoring',
    },
  ],
  handicrafts: [
    {
    ...
    {
      title: 'Wooden Craft Box',
      price: 45,
      description: 'Hand-carved wooden box',
    },
    {
      title: 'Ceramic Vase',
      price: 35,
  ...
  'building-materials': [
    ...
    },
    {
      ...
      price: 200,
      description: 'Construction steel reinforcement',
    },
    {
      title: 'Concrete Blocks',
      price: 2,
      description: 'Building blocks for walls',
    },
    { title: 'Ceramic Tiles', price: 25, description: 'Floor and wall tiles' },
    {
      title: 'Paint Cans Set',
      price: 80,
  ...
  'industrial-equipment': [
    ...
    },
    {
      ...
      price: 15000,
      description: 'Used forklift in good condition',
    },
    {
  ...
  'sports-equipment': [
    {
      title: 'Treadmill Exercise Machine',
      price: 800,
      description: 'Home fitness treadmill',
    },
    {
  ...
  'musical-equipment': [
    {
      ...
      price: 300,
      description: 'Quality acoustic guitar',
    },
    ...
    },
    {
      ...
      price: 150,
      description: 'Professional microphone kit',
    },
  ],
  animals: [
    {
    ...
    },
    {
      ...
      price: 50,
      description: 'Premium pet food variety pack',
    },
  ],
  'medical-supplies': [
    {
      ...
      price: 80,
      description: 'Digital blood pressure device',
    },
    ...
    },
    {
      title: 'Medical Scale',
      price: 120,
      description: 'Digital medical scale',
    },
  ],
  foodstuffs: [
    {
    ...
    },
    {
      ...
      price: 60,
      description: 'High-quality beef selection',
    },
    {
      title: 'Artisan Cheese Set',
      price: 35,
      description: 'Gourmet cheese variety',
    },
    {
      title: 'Fresh Baked Bread',
      price: 8,
      description: 'Artisan bread selection',
    },
    {
      title: 'Organic Juice Set',
      price: 20,
...
async function main() {
  ...
  const newCategoryData = [
    ...
    {
      name: 'Jobs',
      subcategories: ['Job Vacancies', 'searching for Job'],
    },
    {
      name: 'Solar Energy',
      subcategories: [
  ...
  for (const user of users) {
    ...
    for (const [categorySlug, products] of Object.entries(productData)) {
      ...
      const subcategories = Array.from(createdSubcategories.values()).filter(
  ...
  for (const listing of listings) {
    ...
    for (let i = 0; i < numViews; i++) {
      const viewerId =
        Math.random() > 0.3 ? (i % 2 === 0 ? user10.id : user11.id) : null;
  ...
  console.log(
    `📁 Categories created: ${categories.length} main categories with subcategories`,
  );
}
main()
  .catch((e) => {
